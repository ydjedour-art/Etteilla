    ...
    <div className="flex flex-wrap gap-2.5">
      {themes.map((theme) => (
        <Link
          ...
          className="inline-flex items-center gap-2 border border-ink/10 bg-card py-2 pl-2.5 pr-4 text-sm font-semibold text-ink transition-colors hover:border-primary hover:bg-primary/10"
        >
